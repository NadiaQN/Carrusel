...
//Que hace cada función
  function pagination(){
    ...
    $('.navegation li .fa-circle').css({'color': '#A4A4A4'});
    $('.navegation li .fa-circle:eq('+ (paginationPos-1) +')').css({'color': '#A901DB'});
  }
  ...
  function nextSlider(){
    ...
    $('.navegation li .fa-circle').css({'color' : '#A4A4A4'});
    $('.navegation li .fa-circle:eq('+ (imgPos-1) +')').css({'color' : '#A901DB'});
    $('.list-images li').hide();
